...
# in specific positions. This challenge will ask you to compute how much you have to 
# spin a single-face lock to open it with a given three-digit code. The procedure for 
# our lock is as follows: (lock-face starts at number 0 and has up to N numbers)
# 
...
# This integers will range inclusively from 1 to 255. 
# The first integer is N: the number of digits on the lock, starting from 0. A lock where N is 5 
# means the printed numbers on the dial are 0, 1, 2, 3, and 5, listed 
# counter-clockwise. 
# The next three numbers are the three digits for the opening code. They will 
# always range inclusively between 0 and N-1.
#
## Output Description
#
# Print the total rotation increments you've had to rotate to open the lock with the 
# given code. See example explanation for details.
# 
