...
You can draw words from our favorite dictionary file: [enable1.txt](https://github.com/dolph/dictionary/blob/master/enable1.txt). Your program should completely ignore case when making the position checks.
...
# Example
![What it looks like](./resources/example.gif)